...
class customerController {
    ...
    // Validate if register succesfull - NABILAH
        if($customer->registerCust() > 0){
            ...
            echo "<script type='text/javascript'>alert('$message');
            window.location = ' /ApplicationLayer/ManageCustomerInterface/login.php';</script>";
            }
    }
  ...
  function viewCustomer(){
    ...
    function editCustomer(){
        ...
        echo "<script type='text/javascript'>alert('$message');
    window.location = ' /ApplicationLayer/ManageCustomerInterface/customerProfile.php?customer_id=".$_POST['customer_id']."';</script>";
        }
    }
}
