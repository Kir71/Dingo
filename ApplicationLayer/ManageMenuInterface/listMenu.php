...
//require_once('C:/xampp/htdocs/Dingo/libs/config.php');
  ...
  <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no">
		...
		<link href="http://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.3.0/css/font-awesome.css" 
				rel="stylesheet"  type='/Dingo/text/css'>
		</link>
...
.hero-image {
  background-image: linear-gradient(rgba(0, 0, 0, 0.2), rgba(0, 0, 0, 0.2)), url("/Dingo/img/dingoLogo3.jfif");
  height: 50%;
  ...
  <div id="content">
    <table id="emp_table" width="100%" border="0" >
      ...
      <tr text-align="center">
        ...
        <td class="solid"><img src="/Dingo/img/<?php echo $row["menu_image"]; ?>" style="width:40px"></td>
