...
?>
  ...
  <div id="menu-nav">
    ...
    <div style="list-style-type: none;" id="navigation-bar">
      ...
      <ul>
        <li><a href="/Dingo/ApplicationLayer/ManageCustomerInterface/home.php"><i
              class="fa fa-home"></i><span>Home</span></a></li>
        <li><a href="/Dingo/ApplicationLayer/ManageMenuInterface/viewMenu.php"><i
              class="fa fa-book"></i><span>Menu</span></a></li>
        <li><a href="/Dingo/ApplicationLayer/ManageOrderInterface/cart.php"><i
              class="fa fa-shopping-cart"></i><span>Cart</span></a></li>
        <li><a href="/Dingo/ApplicationLayer/ManageRefundInterface/refundList.php"><i
              class="fa fa-money"></i><span>Refund</span></a></li>
        <li><a href="/Dingo/ApplicationLayer/ManageCustomerInterface/logout.php"
            onclick="return confirm('Are you sure you want to sign out?')"><i class="fa fa-sign-out"></i><span>Sign
              Out</span></a></li>

        <a href="/Dingo/ApplicationLayer/ManageCustomerInterface/customerProfile.php" id="topnav-right"><i
      ...
      <div class="row">
        <center>
          ...
          <div class="col-sm-20 main-content">
            ...
            <form action="/Dingo/ApplicationLayer/ManageMenuInterface/viewMenu.php" method="post">
