...
require_once 'C:/xampp/htdocs /BusinessServiceLayer/controller/menuController.php';
...
<div class="row">
  <div class="column">
    <centre><img src="../../img/<?php echo $row['menu_image'];?>" width="340" height="340"></centre>
  </div>
  ...
  <div class="column" style="background-color:#c69f9f;">
    ...
    <br>
                  ...
                  $name = $_SESSION['username'];
                    ...
                    <centre><button class="btn btn-primary" type="submit" name="add" value="Add to Cart"> Add to Cart </button></centre>
