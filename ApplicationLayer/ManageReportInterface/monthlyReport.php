...
<link rel="stylesheet" href=" /css/monthlyStyle.css">
    ...
    <link rel="stylesheet" href="\tableMonthly.css">
	<style>
  <!-- NAVIGATION STYLE -->
  body, html {
  height: 100%;
...
<!-- /BUTTON STYLE -->
  ...
  <div style="list-style-type: none;" id="navigation-bar">
     <ul>
      ...
      <?php //<li><a href=" /ApplicationLayer/ManageRefundInterface/refundList.php"><i class="fa fa-money"></i><span>Refund</span></a></li> ?>
...
<script src='https://cdnjs.cloudflare.com/ajax/libs/snap.svg/0.3.0/snap.svg-min.js'></script><script  src=" /js/monthlyScript.js"></script>
