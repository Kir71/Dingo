...
?>
  <head>
    <link rel="stylesheet" href="/Dingo/css/dingo.css">
    ...
    <div id="menu-nav">
        <div style="list-style-type: none;" id="navigation-bar">
            <ul>
                ...
                <li><a href="/Dingo/ApplicationLayer/ManageOrderInterface/orderList.php"><i class="fa fa-user"></i><span>Order</span></a></li>
